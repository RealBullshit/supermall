  ...
  export default {
    ...
    created() {
      ...
      getDetail(this.iid).then(res => {
        ...
        //   //2.第二次获取：值不对
        //   //值不对的原因：图片没有计算在内
        //   //根据最新的数据，对应的DOM是已经加载完了，但是图片依然没有加载完（目前获取到的offsetTop不包含其中的图片）
      ...
      //4.给getThemeTopY赋值(对给this.themeTopYs赋值进行防抖)
    ...
    methods: {
      ...
      contentScroll(position) {
        ...
        //length - 1：为了方便比较加了个最大值，所以遍历的时候可以不遍历最后一个
